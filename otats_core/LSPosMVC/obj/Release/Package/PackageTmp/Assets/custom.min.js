function init_sidebar() {
    ...
    var a = function () {
        ...
        var a = $(window).outerHeight()
            ...
            , d = a < c ? c : a;
        d -= $NAV_MENU.height() + 10,
            $RIGHT_COL.css("height", d)
    };
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        $SIDEBAR_MENU.find('a[href="' + CURRENT_URL_WITHPARAM + '"]').parent("li").addClass("current-page"),
        ...
        $SIDEBAR_MENU.find("a").filter(function () {
            return this.href == CURRENT_URL_WITHPARAM
...
var CURRENT_URL = window.location.href.split("#")[0].split("?")[0]
    , CURRENT_URL_WITHPARAM = window.location.href.split("#")[0]
    , $BODY = $("body")
...
$.fn.popover.Constructor.prototype.leave = function (a) {
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: '/ChucNang/GetChucNangByTaiKhoan',
            type: 'GET',
            ...
            if (response.length > 0) {
                ...
                $.each(response, function (index, item) {
                    html += '<li><a>';
                    html += ' <i class="' + item.Icon + '"></i>' + item.TenNhomChucNang;
                    html += '<span class="fa fa-chevron-right"></span><span class="fa fa-chevron-down"></span></a>';
                    html += '<ul class="nav child_menu">';
                    $.each(item.lstChucNang, function (index2, item2) {
                        html += '<li><a href="' + item2.Url + '">' + item2.TenChucNang + '</a></li>';
                    });
                    html += "</ul></li>";
                })
                $("#main-menu").html(html);
