...
/// </summary>
public class banglotrinhOBJ
{
    public banglotrinhOBJ() { }
    ...
    public double ThoiGianDungDo_Giay
    {
        ...
        {
            double tg = 0;
            if (speed == 0 && DateTime.ParseExact(thoigianketthuc, new string[] { "dd/MM/yyyy HH:mm:ss"},null,System.Globalization.DateTimeStyles.None  ).Year > 2000)
            {
