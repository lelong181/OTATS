angular.module('app').controller('baocaodoisoatdichvuController', function ($rootScope, $scope, $state, Notification, baoCaoKhachHangDataService, ComboboxDataService) {
    CreateSiteMap();
    ...
    function listColumnsgrid() {
        ...
        if ($rootScope.UserInfo.username == 'demo') {
            dataList.push({
                field: "tenKhachHang", title: "Khách hàng",
                attributes: {
                    style: "text-align: center"
                },
                headerAttributes: { "class": "table-header-cell", style: "text-align: center" },
            ...
            dataList.push({
                field: "tenNhanVien", title: "Nhân viên",
                attributes: {
                    style: "text-align: center"
                },
                headerAttributes: { "class": "table-header-cell", style: "text-align: center" },
        ...
        dataList.push({
            field: "createDate", title: "Thời gian",
            format: "{0:dd/MM/yyyy}",
            attributes: {
                style: "text-align: center"
            },
        ...
        dataList.push({
            ...
            //    console.log(e);
            //    if (e.giaBan) {
            //        return '<b>' + kendo.toString(e.giaBan.min, "n0") + '</b>'
            //    } else if (e.aggregates.soLuong) {

            //        return kendo.toString(e.aggregates.giaBan.min, "n0");
            //    } else {
            //        return "";
            //    }
            //},
        ...
        dataList.push({
            ...
            groupHeaderColumnTemplate: function (e) {
                if (e.soLuong) {
                    return '<b>' + kendo.toString(e.soLuong.sum, "n0") + '</b>'
                } else if (e.aggregates.soLuong) {

                    return kendo.toString(e.aggregates.soLuong.sum, "n0");
                } else {
                    return "";
                }
            },
            footerTemplate: function (e) {
                if (e.soLuong) {
                    return kendo.toString(e.soLuong.sum, $rootScope.UserInfo.dinhDangSo);
                }
            },
            footerAttributes: { style: "text-align: right; font-weight:700" },
            attributes: {
        ...
        dataList.push({
            ...
            groupHeaderColumnTemplate: function (e) {
                if (e.tongTienDichVu) {
                    return '<b>' + kendo.toString(e.tongTienDichVu.sum, "n0") + '</b>'
                } else if (e.aggregates.tongTienDichVu) {

                    return kendo.toString(e.aggregates.tongTienDichVu.sum, "n0");
                } else {
                    return "";
                }
            },
...
/*                    pageSize: 200,*/
        ...
        baoCaoKhachHangDataService.getdoisoatdichvu(sitecode, fromdate, todate).then(function (result) {
            $scope.gridData = {
                data: result.data,
                schema: {
                    model: {
