(function () {
    ...
    function bieuDoDoanhThuDataService($http, $cookies, $rootScope, $timeout) {
        ...
        service.getBaoCaoChietKhauDoanhThuTheoNhomNhanVien = getBaoCaoChietKhauDoanhThuTheoNhomNhanVien;
        ...
        service.gettonghopdichvutheobooking2 = gettonghopdichvutheobooking2;
        service.checkstatusticket = checkstatusticket;
        ...
        service.getBaoCaoDoanhThuCacDiem = getBaoCaoDoanhThuCacDiem;
        ...
        function getBaoCaoChietKhauDoanhThuTheoNhomNhanVien(fromdate, todate) {
            return $http.get(urlApi + '/api/BieuDoDoanhThu/APIChietKhauDoanhThuTheoNhomNhanVien?fromdate=' + fromdate + '&todate=' + todate).then(function (response) {
                return { flag: true, data: response.data }
            }, function (response) {
                return { flag: false, data: [] }
            });
        ...
        function gettonghopdichvutheobooking2(sitecode, fromdate, todate) {
            return $http.get(urlApi + '/api/baocao/gettonghopdichvutheobooking2?SiteCode=' + sitecode + '&From=' + fromdate + '&To=' + todate).then(function (response) {
                return { flag: true, data: response.data }
            }, function (response) {
                return { flag: false, data: [] }
            });
        ...
        function checkstatusticket(sitecode, bookingcode, serviceid) {
            return $http.get(urlApi + '/api/baocao/checkusingticket?SiteCode=' + sitecode + '&BookingCode=' + bookingcode + '&ServiceID=' + serviceid).then(function (response) {
                return { flag: true, data: response.data }
            }, function (response) {
                return { flag: false, data: [] }
            });
        ...
        function getBaoCaoDoanhThuCacDiem(ID_DanhMuc, fromdate, todate, SiteCode) {
            return $http.get(urlApi + '/api/baocao/TongHopSoLuongVeBanCacKhu?ID_DanhMuc=' + ID_DanhMuc + '&From=' + fromdate + '&To=' + todate + '&SiteCode=' + SiteCode).then(function (response) {
                return { flag: true, data: response.data }
            }, function (response) {
                return { flag: false, data: [] }
            });
