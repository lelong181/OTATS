angular.module('app').controller('addDonHangController', function ($rootScope, $scope, $state, $stateParams, $timeout, Notification, donHangDataService, ComboboxDataService, printer) {
    CreateSiteMap();
    ...
    $scope.luudonhang = function () {
        if (validatethem()) {
            ...
            donHangDataService.themdonhang(data).then(function (result) {
                if (result.flag) {
