angular.module('app').controller('editDonHangHDVController', function ($rootScope, $scope, $state, $stateParams, $timeout, Notification, donHangDataService, ComboboxDataService, printer) {
    CreateSiteMap();
    ...
    function listColumnsgridXuLy() {
        ...
        dataList.push({
            ...
            template: function (e) {
                if ($scope.objectDonHang.iD_TrangThaiDongHang == 3 && e.site.siteCode == 'TAMCOC') {
                    let link = "https://server.lscloud.vn/Booking/PrintQRTicketByBookingCodeForTamCoc?ID_ChiTietDonHang=0&ID_DonHang="
                        + e.iD_DonHang
                ...
                if ($scope.objectDonHang.iD_TrangThaiDongHang == 3 && e.site.siteCode == 'BAIDINH') {
