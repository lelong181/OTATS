angular.module('app').controller('donHangOTAController', function ($rootScope, $scope, $location, $state, $stateParams, $timeout, Notification, ComboboxDataService, donHangDataService) {
    CreateSiteMap();
    ...
    function openFormDetail(_id) {
        ...
        let url = $state.href('editdonhangota', { iddonhang: _id });
