angular.module('app').controller('editDonHangOTAController', function ($rootScope, $scope, $state, $stateParams, $timeout, Notification, donHangDataService, lspayDataService, ComboboxDataService, printer) {
    CreateSiteMap();
    ...
    function getquyen() {
        ...
        ComboboxDataService.getquyen(url).then(function (result) {
            ...
            if ($scope.permission.iD_ChucNang <= 0) {
                ...
                $location.path('/danhsachdonhangota')
            }
        });
    }
    ...
    function loadgridThanhToan() {
        ...
        lspayDataService.getTongSoDu($scope.nhanvien.iD_Nhom).then(function (result) {
    ...
    function loadgridXuLy() {
        ...
        donHangDataService.getLichSuThanhToan(__iddonhang).then(function (result) {
            $scope.lichsuthanhtoan = result.data[0];
            console.log($scope.lichsuthanhtoan);
        })
    }
    ...
    function listColumnsgridchitietve() {
        ...
        dataList.push({
            ...
            editor: function (container, options) {
                $('<input onkeyup="keyupMaVeBoSung(this)" class="k-textbox" name="' + options.field + '"/>').appendTo(container)
            }
        });
    ...
    $scope.keyupMaVeBoSung = function (input) {
        console.log(input);
        if (event.key === 'Enter')
