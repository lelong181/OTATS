angular.module('app').controller('donHangPCHLController', function ($rootScope, $scope, $location, $state, $stateParams, $timeout, Notification, ComboboxDataService, donHangDataService) {
    CreateSiteMap();
    ...
    function listColumnsgrid() {
        ...
        dataList.push({
            field: "tenTrangThaiDongHang", title: $.i18n("header_trangthaihoantat"),
            template: function (e) {
        ...
        dataList.push({ field: "ngayLap", title: $.i18n("header_ngaylap"), headerAttributes: { "class": "table-header-cell", style: "text-align: center" }, filterable: defaultFilterableGrid, width: "100px" });

        dataList.push({
            field: "isProcess_Name", title: $.i18n("header_trangthaidonhang"),
            template: function (dataItem) {
                return "<span> <i class='fas fa-circle fas-sm' ng-class='{success: dataItem.isProcess == 0, primary: dataItem.isProcess == 1, danger: dataItem.isProcess == 2}'></i> " + kendo.htmlEncode(dataItem.isProcess_Name) + "</span>";
            },
    ...
    function openFormDetail(_id) {
        ...
        let url = $state.href('editdonhangpchl', { iddonhang: _id });
    ...
    //}
    $scope.themdonhang = function () {
        let url = $state.href('adddonhangpchl');
        window.open(url, '_blank');
