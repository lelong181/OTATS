angular.module('app').controller('donHangPKDController', function ($rootScope, $scope, $location, $state, $stateParams, $timeout, Notification, ComboboxDataService, donHangDataService) {
    CreateSiteMap();
