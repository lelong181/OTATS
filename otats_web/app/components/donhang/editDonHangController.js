angular.module('app').controller('editDonHangController', function ($rootScope, $scope, $state, $stateParams, $timeout, Notification, donHangDataService, ComboboxDataService, printer) {
    CreateSiteMap();
    ...
    function listColumnsgridThanhToan() {
        ...
        dataList.push({
            field: "hinhThucThanhToan", title: "Hình thức",
        ...
        dataList.push({
            ...
            template: function (e) {
                if ($scope.objectDonHang.iD_TrangThaiDongHang == 3) {
                    ...
                    return "<a href='" + link + "' target='_blank'> <i class='fas fa-link'></i> In vé</a>"
                } else {
                    return "";
                }
            },
