...
angular.module('app').controller('posBanVeBDController', function ($rootScope, $scope, $state, $stateParams, $timeout, Notification, donHangDataService, ComboboxDataService, printer) {
    CreateSiteMap();
    ...
    function loadgridhangchon() {
        ...
        donHangDataService.getdanhsachmathangbyidkhachhangmultiidnhom(__idkhachhang, __idnhom).then(function (result) {
            ...
            let arr_hangchonchuachon = arr_hangchonall.filter((item) => {
                ...
                html = html.replace("PCHL", "<b style='color:#CD1818'>PCHL</b>");
                html = html.replace("Green Pine", "<b style='color:#107100'>Green Pine</b>");
                item.tenHang = html;
    ...
    function validatethem() {
        ...
        if (flag)
            flag = validatesoluongmathang(_chitietdonhang);
        if (flag)
    ...
    function validatesoluongmathang(_chitietdonhang) {
        let message = "";
        let flag = true;

        _chitietdonhang.forEach(function (item) {
    ...
    $scope.openvnpaykhecoc = function (data) {

        window.open("https://server.lscloud.vn/Booking/VnpayWaitPayment_KC?ID_DonHang=" + data.iddonhang
            + "&ThuNgan=" + $("#nhanvien").data("kendoComboBox").text(), "mozillaWindow", "popup")
        $scope.huydonhang();
    }
    ...
    $scope.inve = function (data) {
        ...
        window.open("https://server.lscloud.vn/Booking/PrintQRTicketByBookingCodeForBaiDinh?ID_ChiTietDonHang=0&ID_DonHang=" + data.iddonhang
            + "&ThuNgan=" + $("#nhanvien").data("kendoComboBox").text() /*+ "&BookingCode=" + data.mabooking + "&SiteCode=BAIDINH"*/
            , "mozillaWindow", "popup")
        $scope.huydonhang();
    }
