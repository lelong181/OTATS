...
angular.module('app').controller('posBanVePCHLController', function ($rootScope, $scope, $state, $stateParams, $timeout, Notification, donHangDataService, ComboboxDataService, printer) {
    CreateSiteMap();
    ...
    $scope.openvnpay = function (data) {

        window.open("https://server.lscloud.vn/Booking/VnpayWaitPayment?ID_DonHang=" + data.iddonhang
    ...
    $scope.inve = function (data) {
        ...
        window.open("https://server.lscloud.vn/Booking/PrintQRTicketByBookingCodeForPCHL?ID_ChiTietDonHang=0&ID_DonHang=" + data.iddonhang
            + "&ThuNgan=" + $("#nhanvien").data("kendoComboBox").text() + "&BookingCode=" + data.mabooking + "&SiteCode=PCHL"
            , "mozillaWindow", "popup")
        $scope.huydonhang();
    }
