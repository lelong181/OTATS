angular.module('app').controller('baoCaoTinNhanNhanVienController', function ($scope, Notification, ComboboxDataService, tinNhanDataService) {
    CreateSiteMap();
    ...
    function loadgrid(idnhanvien) {
        ...
        tinNhanDataService.baocaotinnhannhanvien(idnhanvien, fromdate, todate).then(function (result) {
            $scope.gridData = {
                data: result.data,
                schema: {
                    model: {
    ...
    $scope.XuatExcel = function () {
        ...
        tinNhanDataService.excelbaocaotinnhannhanvien(idnhanvien, fromdate, todate).then(function (result) {
            if (result.flag)
